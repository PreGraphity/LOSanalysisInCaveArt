...
TP_shp = "TP.shp"
TPs_shp = "TPs.shp"
FixedFires_shp = "FixedFires.shp"
BufferFires_shp = "BufferFires.shp"
...
arcpy.Buffer_analysis(FixedFires_shp, BufferFires_shp, "3,30  Meters", "FULL", "ROUND", "NONE", "", "PLANAR")

# Process: Clip analysis
arcpy.Clip_analysis(TP_shp, BufferFires_shp, TPs_shp)

# Process: Buffer analysis
arcpy.Buffer_analysis(TPs_shp, Buffer_shp, "22,35  Meters", "FULL", "ROUND", "NONE", "", "PLANAR")

# Process: Clip analysis
arcpy.Clip_analysis(OP_shp, Buffer_shp, OPs_shp)

# Process: Construct Sight Lines
arcpy.ConstructSightLines_3d(OPs_shp, TPs_shp, LS_shp, "grid_code", "Shape.Z", "<None>", "1", "NOT_OUTPUT_THE_DIRECTION")

# Process: Intervisibility
arcpy.Intervisibility_3d(LS_shp, CeilingsMax_shp, "VISIBLE")

# Process: Select
arcpy.Select_analysis(LS_shp, LSSelect_shp, "\"VISIBLE\" = 1")
...
arcpy.JoinField_management(TPs_shp, "FID", TargetStatistics_dbf, "OID_TARGET", "COUNT_OID_")

# Process: Add Field (2)
arcpy.AddField_management(TPs_shp, "Frequency", "DOUBLE", 100, 10, 10, "", "NON_NULLABLE", "NON_REQUIRED")
...
arcpy.PointToRaster_conversion(TPs_shp, "Frequency", TPFrequency_tif, "MAXIMUM", "NONE", "0,25")

# Process: Kernel Density (2)
arcpy.gp.KernelDensity_sa(TPs_shp, "Frequency", TPKernelDensity_tif, "0,25", "2", "SQUARE_MAP_UNITS", "DENSITIES", "PLANAR")
